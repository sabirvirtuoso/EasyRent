<div class="col-md-5">
    <img class="img-responsive md-margin-bottom-10" src="/EasyRent/rentalImageDisplay?id=${rental.id}&image=imageOne"
         alt="">
</div>
...
<div class="col-md-7">
    ...
    <span><strong>Bedrooms : </strong>${rental.bedrooms}</span>
