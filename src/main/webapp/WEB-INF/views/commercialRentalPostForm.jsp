...
<c:import url="header.jsp">
    <c:param name="title" value="Commercial Rental Post"></c:param>
</c:import>
...
<div class="container content">
    ...
    <div class="col-md-10">
        ...
        <sf:form action="/EasyRent/commercial/add" cssClass="sky-form" method="POST" enctype="multipart/form-data"
                 commandName="commercialRental">
            <header>Commercial Rental Post Form</header>
