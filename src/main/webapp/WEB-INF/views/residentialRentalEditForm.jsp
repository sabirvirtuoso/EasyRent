...
<c:import url="header.jsp">
    <c:param name="title" value="Residential Rental Edit"></c:param>
</c:import>
...
<div class="container content">
    ...
    <div class="col-md-10">
        ...
        <sf:form action="/EasyRent/residential/edit/${rental.id}" cssClass="sky-form" method="POST" enctype="multipart/form-data" commandName="rental">
            <header>Residential Rental Edit Form</header>
